...
public class FFmpegService : IFFmpegService
{
    ...
    /// <inheritdoc />
    public async Task<bool> DownloadFileAsync(string url, string outputPath, int readRate, IProgress<double> progress, CancellationToken cancellationToken, string audioLanguageCode = "deu", bool cleanAudioTrackLabel = false, Metadata.MediaMetadata? metadata = null)
    {
        try
        {
